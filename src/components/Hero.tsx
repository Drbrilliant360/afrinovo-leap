      ...
      <div className="relative container mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 lg:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1
            ...
            className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight px-2"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground mb-6 sm:mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed px-4"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-10 md:mb-16 px-4"
          >
            <Button 
              size="lg" 
              variant="premium"
