...
import { Code, Megaphone, Lightbulb, Package, Search, Wrench, ShoppingCart, Users, Handshake, TrendingUp } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-lg text-muted-foreground">Comprehensive solutions to drive your digital transformation</p>
          </div>
        </ScrollReveal>

        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-6xl mx-auto mb-8 sm:mb-12" staggerDelay={0.06}>
          {services.map((service, index) => (
            <StaggerItem key={index}>
              <div className="group flex items-start gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 bg-card rounded-xl sm:rounded-2xl border border-border hover:border-secondary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] h-full">
