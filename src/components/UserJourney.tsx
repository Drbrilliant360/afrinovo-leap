...
export const UserJourney = () => {
  const steps = [
    { icon: Lightbulb, title: "Awareness", description: "Discover afrinova through community, tech, and digital channels" },
    { icon: MousePointer, title: "Engagement", description: "Access intuitive platforms designed for user needs" },
    { icon: Sparkles, title: "Experience", description: "Enjoy seamless digital services, mentorship, and trustworthy systems" },
    { icon: TrendingUp, title: "Growth", description: "Feedback and innovation improve long-term value & user benefits" },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-lg text-muted-foreground">Your journey from discovery to growth</p>
          </div>
        </ScrollReveal>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 relative" staggerDelay={0.15}>
              ...
              <StaggerItem key={index}>
                <div className="relative">
                  <div className="bg-card p-4 sm:p-5 md:p-6 lg:p-8 rounded-xl sm:rounded-2xl lg:rounded-3xl border border-border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 active:scale-[0.98]">
                    ...
                    <p className="text-muted-foreground text-center text-xs sm:text-sm leading-relaxed">{step.description}</p>
                  </div>
                </div>
              </StaggerItem>
            ))}
